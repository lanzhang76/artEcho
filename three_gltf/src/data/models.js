export const models = [
  {
    name: "chamber1",
    data: [
      { name: "Geochelone carbonaria", path: "../models/c1/geochelone/USNM_222486-100k-2048.gltf", mesh: null, box: null, scale: 1, position: { x: 3, y: 1, z: -3 }, rotation: { x: 0, y: 0, z: 0 }, offset: { x: 0, y: 1, z: 0 }, theta: Math.PI / 2, stare_dist: 1.5 },
      {
  ...
  },
  {
    name: "chamber2",
    data: [
      { name: "Baluster vase", path: "../models/vase1/f1980_193-150k-4096.gltf", mesh: null, box: null, scale: 1, position: { x: -2, y: 0.1, z: -22 }, rotation: { x: 0, y: 0, z: 0 }, offset: { x: 0, y: 0, z: 0 }, theta: Math.PI * 2, stare_dist: 0.5 },
      { name: "Beaker-shaped vase", path: "../models/vase2/baluster_vase-150k-4096.gltf", mesh: null, box: null, scale: 1, position: { x: 2, y: 0.1, z: -22 }, rotation: { x: 0, y: 0, z: 0 }, offset: { x: 0, y: 0, z: 0 }, theta: Math.PI * 2, stare_dist: 0.5 },
      { name: "fangyi", path: "../models/fangyi/fangyi-150k-4096.gltf", mesh: null, box: null, scale: 1, position: { x: -2, y: 0.1, z: -20 }, rotation: { x: 0, y: 0, z: 0 }, offset: { x: 0, y: 0, z: 0 }, theta: Math.PI * 2, stare_dist: 0.5 },
      { name: "ewer", path: "../models/ewer/lidded_ewer-150k-4096.gltf.gltf", mesh: null, box: null, scale: 1, position: { x: 2, y: 0.1, z: -20 }, rotation: { x: 0, y: 0, z: 0 }, offset: { x: 0, y: 0, z: 0 }, theta: Math.PI * 2, stare_dist: 0.5 },
    ],
    soundsFiles: [],
  },
  {
